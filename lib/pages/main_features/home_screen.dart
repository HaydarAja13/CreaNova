...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // Memulai pengambilan data profil saat widget pertama kali dibuat
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          // DIUBAH: Menggunakan FutureBuilder untuk menampilkan alamat
                    ...
                    children: [
                      ...
                      StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                        ...
                        builder: (context, snap) {
                          // 2. Menangani state saat data sedang loading
                          if (snap.connectionState == ConnectionState.waiting) {
                            // Menampilkan placeholder sederhana saat menunggu data
                            return const Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(
                          ...
                          // Mengambil data dan memberikan nilai default 0 jika null
                      ...
                      // 4. Spacer untuk mendorong tombol aksi ke kanan secara otomatis
                      const Spacer(),
